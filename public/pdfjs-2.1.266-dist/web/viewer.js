...
/***/ (function(module, exports, __webpack_require__) {
  ...
  function webViewerfollow() {
    alert('hjhjk');
    PDFViewerApplication.page=window.pagenumber;
  }
  ...
  var defaultOptions = {
    ...
    defaultUrl: {
      ...
      // value: '../../pdfjs-2.1.266-dist/web/620cbd30421c0_products(1).pdf',
      value: '../../pdfjs-2.1.266-dist/web/'+window.pdfname,
    ...
    workerSrc: {
      value: '../../pdfjs-2.1.266-dist/build/pdf.worker.js',
      kind: OptionKind.WORKER
    }
  };
  {
    ...
    function PDFDocumentProperties(_ref, overlayManager, eventBus) {
      ...
      if (eventBus) {
        eventBus.on('pagechanging', function (evt) {
          ...
          window.pagenumber=_this._currentPageNumber;
